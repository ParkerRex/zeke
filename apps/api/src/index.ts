...
app.doc("/openapi", {
  ...
  info: {
    ...
    title: "Zeke API",
    description:
      "Zeke is a platform for Research Intelligence, Chat Assistance, and Workspace Management.",
    contact: {
      name: "Zeke Support",
      email: "engineer@zeke.ai",
      url: "https://zekehq.com",
    },
    license: {
      name: "AGPL-3.0 license",
      url: "https://github.com/zekehq/zeke/blob/main/LICENSE",
    },
  },
  servers: [
    {
      url: "https://api.zeke.hq",
...
app.openAPIRegistry.registerComponent("securitySchemes", "token", {
  ...
  "x-speakeasy-example": "ZEKE_API_KEY",
});

app.get(
  "/",
  Scalar({ url: "/openapi", pageTitle: "Zeke API", theme: "saturn" }),
);
