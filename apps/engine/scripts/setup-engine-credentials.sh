...
# Setup engine database credentials (worker DB role)
...
echo -e "${BLUE}🔧 Setting up engine database credentials (worker role)...${NC}"
...
echo -e "${GREEN}🎉 Engine credentials setup complete!${NC}"
