            ...
            <Card>
              <CardContent className="prose prose-gray dark:prose-invert max-w-none p-8">
                ...
                <p>
                  ...
                  rest, access controls, and regular security audits.
                </p>

                <h3>Retention</h3>
                <p>
                  We retain your data as long as your account is active or as
                  needed to provide services. Research content and generated
                  briefs are kept to improve our algorithms, but can be deleted
                  upon request.
                </p>

                <h3>Contact Us</h3>
                <p>
                  For data access, deletion requests, or privacy questions,
                  contact us via our
