...
describe('PageHeader', () => {
  ...
  it('renders description when provided', () => {
    ...
    const description = screen.getByText('This is a test description for the page');
  ...
  it('renders without children when not provided', () => {
    ...
    expect(document.querySelector('.flex.items-center.gap-2')).not.toBeInTheDocument();
  });
  ...
  it('has correct responsive layout structure', () => {
    ...
    const layoutContainer = document.querySelector('.flex.flex-col.gap-4.sm\\:flex-row.sm\\:items-center.sm\\:justify-between');
  ...
  it('renders complete header with all props', () => {
    ...
    expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent('Complete Header');
  ...
  it('handles long titles gracefully', () => {
    const longTitle = "This is a very long page title that might wrap to multiple lines in smaller viewports";
  ...
  it('handles long descriptions gracefully', () => {
    const longDescription = "This is a very long description that provides detailed information about the page content and might span multiple lines depending on the viewport size and content length.";
