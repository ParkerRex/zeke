...
const highlightItems = [
	{
		...
		copy:
			"Drop podcasts, papers, product updates, and posts. Zeke flags the claims, numbers, and contradictions you would have missed without a full-time researcher.",
	},
	{
		title: "Receipts on every insight",
		copy:
			"Every brief is grounded by citations, timestamps, and uncertainty flags so you can jump straight to proof and never ship AI slop.",
	},
	{
		title: "Apply instantly",
		copy:
			"Load your goals or SOPs to turn findings into playbooks, prompts, and enablement assets that ship right away.",
	},
];
		...
		<div className="container mb-52">
			...
			<div className="relative mt-28 grid gap-6 rounded-[32px] border border-border/60 bg-muted/20 p-10 md:grid-cols-3">
				{highlightItems.map((item) => (
					<div key={item.title} className="flex flex-col gap-3 rounded-2xl bg-background/70 p-6 shadow-sm">
			...
			<div className="flex items-center flex-col text-center relative mt-28">
				<div className="max-w-[640px]">
					...
					<p className="text-sm md:text-base text-muted-foreground">
						...
						Zeke produces role-aware takeaways and outputs—PRDs, enablement decks,
						campaign angles, experiment plans—with receipts attached.
					</p>
				</div>
					...
					<div className="grid gap-6 md:grid-cols-2">
						<div className="rounded-2xl border border-border/40 bg-background/80 p-6">
							...
							<ul className="mt-4 space-y-3 text-sm text-muted-foreground">
								<li>6–10 bullet "Why it matters" recap with chapter jump links</li>
								<li>Claim ledger with timestamps, sources, and yellow flags for uncertainty</li>
						...
						<div className="rounded-2xl border border-border/40 bg-background/80 p-6">
							...
							<ul className="mt-4 space-y-3 text-sm text-muted-foreground">
								<li>Experiment plans, enablement emails, briefs, and content outlines</li>
				...
				<div className="mt-32 max-w-[550px]">
					<h3 className="font-medium text-xl md:text-2xl mb-4">Ask Zeke anything</h3>
					<p className="text-[#878787] text-sm md:text-base md:mb-10">
						Our assistant is tuned for research ops. Ask for the claim map, find
						contradictions, or spin up a playbook. Every answer brings receipts so
