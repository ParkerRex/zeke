      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC ("us", "we", or "our") operates the ZEKE
          ...
          <ul>
            <li>
              ...
              <p className="leading-7 mt-8">
                Service is the ZEKE application operated by Minton Holdings LLC
              </p>
            </li>
            <li>
              <p className="leading-7 mt-8">
          ...
          <h2>Use of Data</h2>
          <p className="leading-7 mt-8">
            Minton Holdings LLC uses the collected data for various purposes:
          </p>
          <ul>
          ...
          <p className="leading-7 mt-8">
            If you are from the European Economic Area (EEA), Minton Holdings
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC may process your Personal Data because:
          </p>
          <ul>
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC will retain your Personal Data only for as long
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC will also retain Usage Data for internal
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC will take all the steps reasonably necessary to
          ...
          <p className="leading-7 mt-8">
            If Minton Holdings LLC is involved in a merger, acquisition or asset
          ...
          <p className="leading-7 mt-8">
            Under certain circumstances, Minton Holdings LLC may be required to
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC may disclose your Personal Data in the good
            faith belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Minton Holdings
              LLC
            </li>
            <li>
          ...
          <p className="leading-7 mt-8">
            ...
            certain data protection rights. Minton Holdings LLC aims to take
          ...
          <ul>
            ...
            <li>
              <p className="leading-7 mt-8">
                ...
                the right to withdraw your consent at any time where Minton
                Holdings LLC relied on your consent to process your personal
                information.
              </p>
            </li>
          </ul>
          ...
          <ul>
            <li>By email: me@parkerrex.com</li>
          </ul>
        </div>
      </div>
    </>
