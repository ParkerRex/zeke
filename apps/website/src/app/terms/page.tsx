    ...
    <>
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          <p className="leading-7 mt-8">Last updated: September 3, 2025</p>
          ...
          <p className="leading-7 mt-8">
            ...
            or Minton Holdings LLC cancels it. You may cancel your Subscription
            through your online account management page or by contacting Minton
            Holdings LLC's customer support.
          </p>
          ...
          <p className="leading-7 mt-8">
            If automatic billing fails, Minton Holdings LLC will issue an
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC may modify Subscription fees at its sole
            discretion. Any changes will take effect at the end of the current
            Billing Cycle.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            granted at the sole discretion of Minton Holdings LLC.
          </p>
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC does not verify the accuracy or suitability of
            any research insights or analysis shared through the Service. Use of
          ...
          <h2>6. Research Intelligence Disclaimer</h2>

          <p className="leading-7 mt-8">
            Minton Holdings LLC is not a professional advisor, researcher, or
            ...
            constitute professional, legal, or business advice.
          </p>

          <p className="leading-7 mt-8">
            You are solely responsible for verifying all insights, analysis, and
            recommendations generated by the Service before using them for
            business decisions. We strongly recommend consulting with qualified
            professionals for important decisions.
          </p>

          <p className="leading-7 mt-8">
            Minton Holdings LLC accepts no liability for any consequences,
            losses, or damages resulting from your use of the Service for
            research or business purposes.
          </p>

          <h2>7. Reliance on AI-Generated Content</h2>

          <p className="leading-7 mt-8">
            ZEKE uses artificial intelligence to analyze content and generate
            insights. The Service provides citations and timestamps for
          ...
          <ul className="list-disc pl-6 mt-4">
            <li className="leading-7">
              All research briefs, insights, and playbooks are generated by AI
              and displayed "as is", without verification or warranty;
            </li>
            <li className="leading-7">
              Minton Holdings LLC cannot guarantee the completeness, accuracy,
              timeliness, or reliability of AI-generated content;
            </li>
            <li className="leading-7">
              You are solely responsible for verifying all information before
              using it for decisions or business purposes;
            </li>
            <li className="leading-7">
              Minton Holdings LLC shall not be liable for any loss, damage, or
              liability arising from the use of AI-generated content, including
              errors, omissions, delays, or misinterpretations;
            </li>
            <li className="leading-7">
              Your reliance on AI-generated insights is entirely at your own
              risk.
            </li>
          </ul>
          ...
          <p className="leading-7 mt-8">
            ...
            infringement, please email me@parkerrex.com with:
          </p>
          <ul className="list-disc pl-6 mt-4">
            <li className="leading-7">
          ...
          <p className="leading-7 mt-8">
            ...
            Minton Holdings LLC and its licensors.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            that are not controlled by Minton Holdings LLC.
          </p>

          <p className="leading-7 mt-8">
            We assume no responsibility for third-party content, privacy
            policies, or practices. You agree that Minton Holdings LLC shall not
            be liable for any loss or damage caused by use of such content or
            services.
          </p>
          ...
          <p className="leading-7 mt-8">
            Minton Holdings LLC and its affiliates, directors, employees, and
          ...
          <p className="leading-7 mt-8">
            These Terms constitute the entire agreement between you and Minton
            Holdings LLC regarding the Service.
          </p>
          ...
          <p className="leading-7 mt-8">me@parkerrex.com</p>
        </div>
      </div>
    </>
  );
