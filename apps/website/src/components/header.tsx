  ...
  const links = [
    {
      ...
      cover: (
        <Link href="/#assistant" onClick={handleOnClick}>
          <div className="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-800 dark:to-blue-900 rounded-lg flex items-center justify-center w-full h-[140px]">
            <div className="text-center text-blue-600 dark:text-blue-300">
              <div className="size-12 mx-auto mb-3 bg-blue-300 dark:bg-blue-600 rounded-lg flex items-center justify-center">
    ...
    },
    {
      ...
      cover: (
        <Link href="/engine" onClick={handleOnClick}>
          <div className="bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-800 dark:to-purple-900 rounded-lg flex items-center justify-center w-full h-[140px]">
            <div className="text-center text-purple-600 dark:text-purple-300">
              <div className="size-12 mx-auto mb-3 bg-purple-300 dark:bg-purple-600 rounded-lg flex items-center justify-center">
                <svg className="size-6" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
      ...
      children: [
        {
          path: "https://github.com/zeke-ai/zeke",
          title: "Open Source",
          icon: <FaGithub size={19} />,
        },
        {
          path: "https://docs.zekehq.com",
          title: "Documentation",
        ...
        },
        {
          ...
          path: "https://discord.gg/BAbK8MsG2F",
          icon: <FaDiscord size={19} />,
        },
        {
          title: "Apps & Integrations",
          path: "https://docs.zekehq.com/integrations",
    ...
    <header className="sticky mt-4 top-4 z-50 px-2 md:px-4 md:flex justify-center">
      <nav className="border border-border px-4 flex items-center backdrop-filter backdrop-blur-xl bg-[#FFFFFF] dark:bg-[#121212] bg-opacity-70 h-[50px] z-20 relative">
        <ContextMenu>
          <ContextMenuTrigger>
            <Link href="/">
              <span className="sr-only">Zeke Logo</span>
