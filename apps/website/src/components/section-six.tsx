    ...
    >
      ...
      <div className="absolute w-full h-full flex items-center justify-center flex-col top-8 xl:top-0">
        ...
        <p className="max-w-[790px] px-4 text-center text-sm md:text-white dark:text-[#878787] mb-12 md:mb-0">
          Ask Zeke to compare sources, flag contradictions, or draft the next
          output. It remembers your team goals, keeps citations in view, and
          adapts the deliverable for every role so research turns into action
          immediately.
        </p>
      ...
      <div>
        <div className="absolute right-12 top-[120px] hidden xl:flex flex-col space-y-8 text-center items-center">
          <div className="text-center">
            ...
            <span className="text-sm mt-1 block">Signal</span>
          </div>
          ...
          <div className="text-center">
            ...
            <span className="text-sm mt-1 block">Playbook</span>
          </div>
          ...
          <div>
            ...
            <span className="text-sm mt-1 block">brief.pdf</span>
          </div>
        </div>

        <div className="w-full h-[600px] bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <p className="text-lg">Research Assistant Background</p>
          </div>
        </div>
      </div>
    </section>
