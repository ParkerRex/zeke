  ...
  createEnv({
    ...
    runtimeEnv: {
      ...
      NEXT_PUBLIC_SUPABASE_SIGN_IN_URL:
        process.env.NEXT_PUBLIC_SUPABASE_SIGN_IN_URL || '/login',
      NEXT_PUBLIC_SUPABASE_SIGN_UP_URL:
        process.env.NEXT_PUBLIC_SUPABASE_SIGN_UP_URL || '/signup',
      NEXT_PUBLIC_SUPABASE_AFTER_SIGN_IN_URL:
        process.env.NEXT_PUBLIC_SUPABASE_AFTER_SIGN_IN_URL || '/home',
      NEXT_PUBLIC_SUPABASE_AFTER_SIGN_UP_URL:
        process.env.NEXT_PUBLIC_SUPABASE_AFTER_SIGN_UP_URL || '/home',
    },
  });
