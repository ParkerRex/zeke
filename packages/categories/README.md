...
```typescript
import { CATEGORIES, getCategoryBySlug, getParentCategory } from '@zeke/categories';
...
```typescript
import { getTaxRateForCategory, getTaxTypeForCountry } from '@zeke/categories';
...
```typescript
import { getCategoryColor, CATEGORY_COLOR_MAP } from '@zeke/categories';
