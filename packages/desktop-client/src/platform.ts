 ...
 * const dashboardLink = createDeepLink('dashboard');           // zeke://dashboard
 * const transactionLink = createDeepLink('transactions/123'); // zeke://transactions/123
 * const settingsLink = createDeepLink('settings/profile');    // zeke://settings/profile
 * ```
 */
