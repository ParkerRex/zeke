...
export const WelcomeEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Welcome to Zeke! I'm Pontus, one of the founders. It's really important to us that you have a great experience ramping up.`;
      ...
      >
        ...
        >
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Welcome to Zeke! I'm Pontus, one of the founders.
            <br />
            <br />
            We built Zeke from over 10 years of running our own businesses,
            knowing firsthand the challenges that come with it. Zeke is built
