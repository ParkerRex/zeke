...
export const Icons = {
  LogoSmall: (props: SVGIconProps) => (
    <SVGIcon size={28} {...props} viewBox="0 0 268 268">
      <path
        fill="currentColor"
        d="M250.984 268H11.5465L3.64626 227.592L150.712 57.6408H68.6712L56.517 98.643L0 93.8892L9.72336 0H250.376L256.454 40.408L105.134 210.359H193.252L206.014 168.169L268 174.111L250.984 268Z"
      />
    </SVGIcon>
  ),
  Logo: (props: any) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1187 478"
      fill="none"
      {...props}
    >
      <g clipPath="url(#clip0_112_15)">
        <path
          fill="currentColor"
          d="M890 486H749.563V427.067H775.097L727.676 372.994H686.943V427.067H711.869V486H572.04V427.067H608.517V127.541H569V68H686.943V317.706H732.54L772.665 271.532H739.835V211.991H877.233V271.532H847.443L788.472 338.363L866.29 427.067H890V486Z"
        />
        <path
          fill="currentColor"
          d="M565 399.328C562.979 422.136 551.054 442.284 529.226 459.77C507.398 477.257 476.879 486 437.67 486C396.843 486 363.09 475.166 336.412 453.498C310.137 431.83 297 399.518 297 356.562C297 317.027 308.925 284.145 332.774 257.915C357.027 231.305 390.78 218 434.032 218C472.029 218 502.75 228.264 526.195 248.791C550.044 269.319 562.17 296.309 562.575 329.762C562.575 342.306 561.16 354.661 558.33 366.826H378.855C383.302 407.501 404.725 427.838 443.127 427.838C464.146 427.838 478.294 423.087 485.57 413.583C493.25 404.079 497.899 395.526 499.516 387.923L565 399.328ZM481.932 324.06C483.549 311.135 480.517 298.97 472.837 287.566C465.561 276.162 452.626 270.46 434.032 270.46C417.863 270.46 405.332 275.401 396.439 285.285C387.546 295.169 381.887 308.094 379.462 324.06H481.932Z"
        />
        <path
          fill="currentColor"
          d="M1162 399.328C1159.98 422.136 1148.05 442.284 1126.23 459.77C1104.4 477.257 1073.88 486 1034.67 486C993.843 486 960.09 475.166 933.412 453.498C907.137 431.83 894 399.518 894 356.562C894 317.027 905.925 284.145 929.774 257.915C954.027 231.305 987.78 218 1031.03 218C1069.03 218 1099.75 228.264 1123.19 248.791C1147.04 269.319 1159.17 296.309 1159.57 329.762C1159.57 342.306 1158.16 354.661 1155.33 366.826H975.855C980.302 407.501 1001.73 427.838 1040.13 427.838C1061.15 427.838 1075.29 423.087 1082.57 413.583C1090.25 404.079 1094.9 395.526 1096.52 387.923L1162 399.328ZM1078.93 324.06C1080.55 311.135 1077.52 298.97 1069.84 287.566C1062.56 276.162 1049.63 270.46 1031.03 270.46C1014.86 270.46 1002.33 275.401 993.439 285.285C984.546 295.169 978.887 308.094 976.462 324.06H1078.93Z"
        />
        <path
          fill="currentColor"
          d="M275.984 478H36.5465L28.6463 437.592L175.712 267.641H93.6712L81.517 308.643L25 303.889L34.7234 210H275.376L281.454 250.408L130.134 420.359H218.252L231.014 378.169L293 384.111L275.984 478Z"
        />
      </g>
      <defs>
        <clipPath id="clip0_112_15">
          <rect width="1187" height="478" fill="white" />
        </clipPath>
      </defs>
    </svg>
  ),
  ...
  Sources: MdOutlineInventory2,
  Stories: MdOutlineMenuBook,
  Insights: MdOutlineLightbulb,
  Briefs: MdCoffee,
  Playbooks: MdOutlineTask,
