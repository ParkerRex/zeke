...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      // Premium, square-edged look
      "border bg-card/80 text-card-foreground shadow-sm ring-1 ring-black/5",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center border-t p-6 pt-0", className)}
    {...props}
  />
))
